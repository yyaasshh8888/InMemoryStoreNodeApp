...
var hackkey_1 = require("./hackkey");
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var store, item1, item2, item3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                store = (0, hackkey_1.default)();
                item1 = store.set({ key: "nottl", value: "Hello this is my first" });
                item2 = store.set({ key: "ttl", value: "Hi from the sky", ttl: 1000 });
                console.log(item1);
                console.log(item2);
